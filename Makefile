...
bench: test
	@echo
	@caffeinate nice -n 0 ./bsq --bench tests/0_bench/valid_10k > /dev/null
...
.PHONY: all debug profile fast test bench sfast clean fclean re